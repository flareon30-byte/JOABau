...
export default function PlanningTimeline() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'PENDING_REVISION': return 'bg-yellow-100 text-yellow-700 border-yellow-200 animate-pulse';
      case 'RETURNED': return 'bg-red-100 text-red-700 border-red-200 animate-pulse';
